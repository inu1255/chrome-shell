                        ...
                        for (var i = (danmus.length - 1); i >= 0; i--) {
                            ...
                            if (danmaku.position == 0) {
                                ...
                                if (nowCount <= maxCount && nowSecCount <= maxCountPerSec) {
                                    ...
                                    $("#" + flyTmpName).css({
                                        "width": $("#" + flyTmpName).width(), "position": "absolute", "top": top_local, "left": left_local
                                    });
                                ...
                                me.topRows[temRow] = 1;
                                $("#" + topTmpId).css({
                                    "width": "100%", "text-align": "center", "position": "absolute", "top": ($(element).data("topSpace")), "left": "0"
                                });
                                ...
                                $("#" + bottomTmpId).css({
                                    "width": options.width, "left": "0", "text-align": "center", "position": "absolute", "bottom": 0 + $(element).data("bottomSpace")
                                });
